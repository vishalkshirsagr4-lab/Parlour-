        ...
        {staff.map((m) => (
          ...
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              {/* 🔥 PREMIUM IMAGE UI */}
              <div className="w-28 h-28 sm:w-32 sm:h-32 flex-shrink-0 relative group">

                {/* Gradient border */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-pink-400 via-rose-400 to-purple-500 p-[2px] shadow-md group-hover:shadow-pink-300/40 transition-all duration-300">
                    ...
                    {m?.image ? (
                      ...
                      >
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/30 transition duration-300">
                          <span className="opacity-0 group-hover:opacity-100 transition text-white text-xs font-semibold bg-white/20 backdrop-blur-md px-3 py-1 rounded-full">
                            View Profile
                          </span>
                        </div>
                      </button>
                    ) : (
                      <div className="h-full w-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center text-white font-bold text-lg shadow-md">
                          {m?.name?.[0] || 'S'}
                        </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  {m?.phone && (
                    <a
                      href={`tel:${m.phone}`}
                      className="bg-black text-white px-4 py-2 rounded-xl font-semibold hover:opacity-90 w-full text-center sm:w-auto transition"
                    >
                      Call
                    </a>
                  )}
      ...
      {selectedImage && (
        ...
        >
          <div
            ...
            className="relative max-h-full max-w-full overflow-hidden rounded-3xl bg-white p-4 shadow-2xl"
          >
            <button
              type="button"
              onClick={() => setSelectedImage(null)}
              className="absolute right-3 top-3 z-10 rounded-full bg-white/90 px-3 py-1 text-sm font-semibold text-gray-700 shadow"
            >
              Close
            </button>
