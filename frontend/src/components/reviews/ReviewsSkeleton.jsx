        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 h-3 w-1/3 animate-pulse rounded bg-gray-200 dark:bg-gray-800" />
            </div>
          </div>
          <div className="mt-4 space-y-2">
            ...
            <div className="h-3 w-9/12 animate-pulse rounded bg-gray-200 dark:bg-gray-800" />
          </div>
        </motion.div>
      ))}
    </div>
